...
CREATE TABLE BUS_STOP_CROWDING (
                                   ...
                                   X_LONGITUDE DOUBLE COMMENT '좌표X 경도 (DETC_LOT 검지 경도)',
                                   Y_LATITUDE DOUBLE COMMENT '좌표Y 위도 (DETC_LAT 검지 위도)',
...
CREATE TABLE NEAR_BY_BUS_STOP (
                                  ...
                                  Y_LATITUDE DOUBLE COMMENT '좌표Y 위도 WGS84',
                                  X_LONGITUDE DOUBLE COMMENT '좌표X 경도 WGS84',
