...
class ApiJsonParserTest {
    ...
    @Test
    void busGoKrParser() throws Exception {
        ...
        TypeReference<CommonApiDTO<ItemNear>> typeReference = new TypeReference<>() {};

        CommonApiDTO<ItemNear> result = objectMapper.readValue(jsonInput, typeReference);
